  ...
  return (
    ...
    We have two manufacturing machines <var>A</var> and <var>B</var>, each of which can perform one task at a time.<br/>
      ...
      <section className='Subsection Subsection3-1'>
        ...
        <Example9 />
        <p>Although this is a small example and it is inaccurate to compare this way, but this approach requires only one backtrace. More important point is, each backtrace is more local and thus less expensive in terms of computation cost.</p>
      </section>
    </section>
  );
};
